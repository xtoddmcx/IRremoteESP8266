...
const uint16_t kFurrionChillCubeStateLength = 18;
const uint16_t kFurrionChillCubeBits = kFurrionChillCubeStateLength * 8;
const uint16_t kFurrionChillCubeFollowStateLength = 12;
const uint16_t kFurrionChillCubeFollowBits = kFurrionChillCubeFollowStateLength * 8;
